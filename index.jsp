...
<h4>AADHAR NUMBER<br>
<input type="text" name="phone" id="phone" placeholder="Your aadhar number.." required>
</h4>

<h4>LICENSE NUMBER<br>
<input type="email" name="mail_Id" id="mail_Id"  onblur="sendInfo()" placeholder="Enter a valid License Number.." required>
</h4><div class="message" id="hello"></div>
<h4>RC BOOK NUMBER<br>
<input type="text" name="organisation" id="organisation" placeholder="Your Rc book number..">
</h4>
<h4>CITY<br>
